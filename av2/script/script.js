document.addEventListener('DOMContentLoaded', () => {
    ...
    // ADICIONAR UM PARAMENTRO PARA QUE PEGUE A O CAMINHO DA IMAGEM
                ...
                <div class="modal-body" style="padding-top:0px;">
                    <div class="row align-items-center">
                        <div class="col-4 d-flex justify-content-center">
                            <img src="./imagens/sobre-mim/perfil.jpg" alt="" class="img-fluid rounded-circle" style="width: 100px; height: 100px;">
                        </div>
                        <div class="col-8">
